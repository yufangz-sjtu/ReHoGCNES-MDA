...
args_global = parser.parse_args(args = ['--num_cpu_core','20','--log_device_placement','--data_prefix','/home/dqw_zyf/MDA/data',\
                                      '--dir_log','.','--gpu','-1234','--eval_train_every','15',\
                                       '--train_config','/home/dqw_zyf/MDA/parameters.yml','--dtype','s',\
                                        '--timeline','--tensorboard',\
                                       '--dualGPU','--cpu_eval','--saved_model_path',''])
